...
Rails.application.config.after_initialize do
  ...
  Rails.application.config.spree_backend.main_menu.add(
    Spree::Admin::MainMenu::SectionBuilder.new("slides", 'file-slides-fill.svg')
      ...
      .with_items([
        Spree::Admin::MainMenu::ItemBuilder.new('all_slides', Spree::Core::Engine.routes.url_helpers.admin_slides_path).build,
        Spree::Admin::MainMenu::ItemBuilder.new('slide_locations', Spree::Core::Engine.routes.url_helpers.admin_slide_locations_path).build
])
      .build
  )
end
